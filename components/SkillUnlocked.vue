        ...
        <div :class="'h-100 bg-' + bg + ' py-4 px-3'">
            ...
            <div class="mt-1 row align-items-center">
                ...
                <div class="col-auto small">
                    ...
                    <span class="text-white text-shadow"><FormatNumber :value="skill.soulLevel" /></span>
                </div>
            ...
            <div class="mt-1 row align-items-center" style="margin-top: -0.5rem !important">
                <div class="col">
                    <div class="my-1 progress bg-progress soul-progress">
                        <div class="progress-bar soul-progress bg-normal" role="progressbar" :style="'width:' + Math.round(100 * this.skill.soulCurrent / this.skill.getSoulMax()) + '%'" :aria-valuenow="Math.round(100 * this.skill.soulCurrent / this.skill.getSoulMax())" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
				<div class="col-auto pe-0">
